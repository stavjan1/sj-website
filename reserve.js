...
(function () {
  ...
  var CONFIG = {
    ...
    whatsapp: 'https://wa.me/972535302887?text=' +
      encodeURIComponent('היי SJ, אני משרת/ת מילואים ויש לי שאלה בחשמל'),
  };

  var COPY = {
    label: 'תומכים במילואים',
    eyebrow: 'SJ הנדסת חשמל',
    title: 'חייל מילואים? אנחנו כאן בשבילך',
    ...
    points: [
      ...
      'זמינות מהירה, גם בערב ובסופי שבוע',
