...
Outputs that the site actually serves: `sale/data/sj-prices.json` and `functions/api/_sj_catalog.js` are generated from `prices_sj_proposed.json` (see the header comment of `_sj_catalog.js`).
