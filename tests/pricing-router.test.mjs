...
const CASES = [
  ...
  // 4.9.2026: the old '### סתירה' note (215 vs 500-600) is gone; Stav's ruling
  // replaced it with the visit + hourly rule, which is what this turn needs.
  ['איתור תקלה בבית פרטי כמה לקחת', ['### תקלה: מתמחרים את האיתור', '### ביקור, מינימום ושעת איתור']],
