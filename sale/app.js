...
2. **כדי לדייק:** עד שתי שאלות, במשפט אחד, ורק אם התשובה מזיזה את המחיר ב-15% ומעלה.
   ...
   **מה כן שווה לשאול**: כל מה שקשור לתוואי ולתשתית, כי שם נמצא הכסף. בעבודת עמדת טעינה או קו תשתית, השאלה האחת שכן שואלים היא איך הכבל עובר: תעלה גלויה, חציבה, מעבר בגבס, או חפירה והרמת משתלבות. הרמת משתלבות לבדה היא ~500 ₪ למטר והיא מכפילה עבודות שלמות.
   אין שאלה שעוברת את המבחן? השמט את הסעיף לגמרי.
...
# מאיפה המספר
- מחירון העבודה של סתיו (מצורף למטה) הוא מקור האמת לעבודה. סעיף תואם = המחיר שלו, לא הערכה. כמה סעיפים = הסכום שלהם.
